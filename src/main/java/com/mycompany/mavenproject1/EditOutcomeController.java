 ...
 * @author Keane Local
 */
public class EditOutcomeController {
    
    @FXML
    Button btnCancelEditOutcome;
    
    @FXML
    Button btnSaveEditOutcome;
    ...
    private static Outcome selectedOutcome;
    ...
    public void initialize() throws SQLException {
        ...
        // set the combobox to previously selected value
        inputName.setText(selectedOutcome.getName());
        inputDesc.setText(selectedOutcome.getDesc());
        inputModule.setValue(selectedOutcome.getoModule().getName());
    }
    ...
    private void userDidClickCancel() throws IOException {
        Stage stage = (Stage) btnCancelEditOutcome.getScene().getWindow();
        stage.close();
    }
    ...
    private void userDidClickSave() throws IOException, SQLException {
        ...
        Outcome newOutcome = new Outcome(tempModule, name, desc, temp, 0);
        DatabaseHelper.updateOutcome(selectedOutcome, newOutcome);
        DatabaseHelper.sortOutcomes(moduleName);
