 ...
 * @author Keane Local
 */
public class NewOutcomeController {
    
    @FXML
    Button btnCancelNewOutcome;
    
    @FXML
    Button btnSaveNewOutcome;
    ...
    public static void display(String title) throws IOException, SQLException {
        ...
        Scene scene = new Scene(App.loadFXML("NewOutcome"), 450, 400);
    ...
    private void userDidClickCancel() throws IOException {
        Stage stage = (Stage) btnCancelNewOutcome.getScene().getWindow();
        stage.close();
    }
    ...
    private void userDidClickSave() throws IOException, SQLException {
        ...
        DatabaseHelper.insertIntoOutcome(newOutcome);
